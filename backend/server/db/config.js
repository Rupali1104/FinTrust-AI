...
function initializeDatabase() {
    db.serialize(() => {
        ...
        db.run(`CREATE TABLE IF NOT EXISTS admins (
            ...
            db.get('SELECT * FROM admins WHERE email = ?', ['admin@fintrust.com'], async (err, row) => {
                if (err) {
...
const createSampleApplications = () => {
    ...
    // First, clear any existing applications
